...
public abstract class ActivityMensajeDineroBinding extends ViewDataBinding {
  @NonNull
  ...
  protected ActivityMensajeDineroBinding(Object _bindingComponent, View _root, int _localFieldCount,
  ...
  @NonNull
  public static ActivityMensajeDineroBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_mensaje_dinero, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityMensajeDineroBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityMensajeDineroBinding>inflateInternal(inflater, R.layout.activity_mensaje_dinero, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_mensaje_dinero, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityMensajeDineroBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityMensajeDineroBinding>inflateInternal(inflater, R.layout.activity_mensaje_dinero, null, false, component);
  }

  public static ActivityMensajeDineroBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityMensajeDineroBinding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityMensajeDineroBinding)bind(component, view, R.layout.activity_mensaje_dinero);
  }
}
