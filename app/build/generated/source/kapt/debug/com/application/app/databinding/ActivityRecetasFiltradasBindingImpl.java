...
public class ActivityRecetasFiltradasBindingImpl extends ActivityRecetasFiltradasBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.searchView, 12);
        sViewsWithIds.put(R.id.xbutton, 13);
        sViewsWithIds.put(R.id.recyclerViewRecetas, 14);
        sViewsWithIds.put(R.id.frameBottombar, 15);
        sViewsWithIds.put(R.id.linear2FourupAO, 16);
        sViewsWithIds.put(R.id.linear1Tab, 17);
        sViewsWithIds.put(R.id.imageHome, 18);
        sViewsWithIds.put(R.id.txtCaption, 19);
        sViewsWithIds.put(R.id.linearColumnvolume, 20);
        sViewsWithIds.put(R.id.linear3Tab, 21);
        sViewsWithIds.put(R.id.imageVolume, 22);
        sViewsWithIds.put(R.id.txtCaptionOne, 23);
    }
    // views
    // variables
    // values
    ...
    public ActivityRecetasFiltradasBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 24, sIncludes, sViewsWithIds));
    }
    private ActivityRecetasFiltradasBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (androidx.appcompat.widget.SearchView) bindings[12]
