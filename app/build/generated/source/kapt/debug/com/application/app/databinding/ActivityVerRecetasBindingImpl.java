...
public class ActivityVerRecetasBindingImpl extends ActivityVerRecetasBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.linearRecetasVer, 12);
        sViewsWithIds.put(R.id.fragmentContainerView3, 13);
        sViewsWithIds.put(R.id.frameBottombar, 14);
        sViewsWithIds.put(R.id.linear2FourupAO, 15);
        sViewsWithIds.put(R.id.linear1Tab, 16);
        sViewsWithIds.put(R.id.imageHome, 17);
        sViewsWithIds.put(R.id.txtCaption, 18);
        sViewsWithIds.put(R.id.linearColumnvolume, 19);
        sViewsWithIds.put(R.id.linear3Tab, 20);
        sViewsWithIds.put(R.id.imageVolume, 21);
        sViewsWithIds.put(R.id.txtCaptionOne, 22);
    }
    // views
    // variables
    // values
    ...
    public ActivityVerRecetasBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 23, sIncludes, sViewsWithIds));
    }
    private ActivityVerRecetasBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
